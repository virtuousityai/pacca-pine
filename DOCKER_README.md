...
## Overview
The Pacca PINE community loves Docker. We eat and breathe Docker. The Pacca PINE dockers and detailed documentation
can be found on [dockerhub](https://hub.docker.com/r/openemr/openemr/). There are two main categories of
dockers for Pacca PINE, Production Dockers and Development Dockers. Production dockers are meant for production
...
series which are highly flexible development dockers that are used to create the standard Pacca PINE development
...
standard Pacca PINE development environments, and can be found on
[dockerhub](https://hub.docker.com/r/openemr/openemr/). It is strongly recommended to not use these dockers
for production purposes unless you know what you are doing. There are 2 Pacca PINE development environments,
